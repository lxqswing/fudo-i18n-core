...
var ICU = /*#__PURE__*/function () {
  ...
  _createClass$1(ICU, [{
    ...
    value: function init(i18next, options) {
      ...
      this.options = defaults(i18nextOptions, options, this.options || {}, getDefaults$1());
    ...
    value: function addUserDefinedFormats(formats) {
      this.formats = this.formats ? _objectSpread$2(_objectSpread$2({}, this.formats), formats) : formats;
    }
  }, {
    key: "parse",
    ...
    value: function escapeVariableValues(options) {
      if (!this.options.escapeVariables || !options || _typeof$3(options) !== 'object') {
        return options;
      }
      var escaped = {};
...
function requireGetFetch () {
	...
	(function (module, exports$1) {
		...
		if (typeof commonjsRequire !== 'undefined' && typeof window === 'undefined') {
		  var f = fetchApi || requireNodePonyfill();
